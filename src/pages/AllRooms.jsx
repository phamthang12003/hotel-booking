...
const AllRooms = () => {
  ...
  return (
    <div className='flex flex-col-reserve lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        {/* filter */}
        <div className='bg-white w-80 border borer-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
            ...
            <div className={`${openFilters ? 'h-auto' : 'h-0 lg:h-auto'} overflow-hidden transition-all duration-700`}>
                ...
                <div className='px-5 pt-5'>
                    <p className='font-medium text-gray-800 pb-2'>Price Ranger</p>
                    {priceRanges.map((range, index) => (
                        <CheckBox key={index} label={`QAR ${range}`}/>
                    ))}
                </div>
